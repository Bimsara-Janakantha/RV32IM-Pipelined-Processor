...
VHDL_FILES=("2sCOMPLEMENTER" "ADDER" "ALU" "AND" "CONTROL_UNIT" "CPU" "DMEM" "FORWARD" "IMM_DECORDER" "MUX2_1" "MUX4_1" "OR" "PC" "REG_EX_MEM" "REG_FILE" "REG_ID_EX" "REG_IF_ID" "REG_MEM_WB" "SHIFT" "SLT" "SLTU" "XOR")
